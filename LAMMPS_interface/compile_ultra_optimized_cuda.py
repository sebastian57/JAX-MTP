...
from motep_original_files.jax_engine.jax_comp import calc_energy_forces_stress_padded_simple_ultra_optimized

from motep_original_files.jax_engine.moment import MomentBasis
...
def main():
    ...
    ULTRA_CONFIGS = [
        (13375, 54, "real size", "Tested size (13k atoms)"),
        (1024, 54, "1k", "Small systems"),
        (4096, 54, "4k", "Medium systems"), 
        (13000, 54, "13k_target", "Target system (13k atoms)"),
        (16384, 54, "16k", "Large systems"),
        (65536, 54, "64k", "Very large systems"),
    ]
